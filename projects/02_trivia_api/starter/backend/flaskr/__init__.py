...
def create_app(test_config=None):
  ...
  '''
    ...
    def get_categories():
        ...
        format_categories = {category.id: category.type for
  ...
  '''
    ...
    def search_question():
        ...
        try:
            ...
            if search_term:
                searched_question = Question.query\
        ...
        try:
          if quiz_category:
            ...
            if not questions:
                ...
                quiz_questions = [q for q in questions if q.id
                                  not in previous_questions]
                q = random.choice(quiz_questions).format()
